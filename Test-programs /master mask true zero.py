...
def sensor():
    ...
    if(ticker > 6):
        ...
        image_area=cv2.rectangle(image_area,((15+48*ticker),945),(10,920),(0,255,0),-1)
    if(ticker >15):
        ticker=15
    if(ticker <= 0):
        ticker=0
        ...
        image_area=cv2.rectangle(image_area,((15+48*ticker),945),(10,920),(0,0,255),-1)
...
camera.contrast = 3 #1 giver bedst detection
#camera.image_effect='blur'
#camera.IMAGE_EFFECTS
camera.exposure_mode = 'backlight'
#camera.EXPOSURE_MODES
camera.awb_mode = 'fluorescent'
maskGain = 0.64 #er alt hvidt = lavt gain, intet hvidt = for højt gain
...
cv2.rectangle(circle2,(960,0),(10,70),(0,0,255),-1)
...
for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	Overlay_area=cv2.circle(overlay,Csys,459,(10,220,30),2)
